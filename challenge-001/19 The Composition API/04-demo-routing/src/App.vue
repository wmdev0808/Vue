...
import { addProductInjectionKey, productsInjectionKey } from "./injectionKeys";
...
provide(productsInjectionKey, products.value);
provide(addProductInjectionKey, addProduct);
</script>
